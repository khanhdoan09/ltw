                        ...
                        <tr>
                            <td class="text-center">
                                ...
                                <a href="product.html"><img class="img-thumbnail"
                                                            ...
                                                            src="image/product/giay1s.jpg"></a>
                            </td>
                            <td class="text-left"><a href="product.html">women's New Wine is an alcoholic</a>
                            </td>
                            <td class="text-left">Sản phẩm 11</td>
                            <td class="text-left">
                            ...
                            <td class="text-right">254.000 VNĐ</td>
                            <td class="text-right">254.000 VNĐ</td>
                        </tr>
                        <!-- ---------------- -->
                        <tr>
