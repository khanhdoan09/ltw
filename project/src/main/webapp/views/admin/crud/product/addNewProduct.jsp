...
<div id="ebazar-layout" class="theme-blue">
    ...
    <div class="main px-lg-4 px-md-4">
        ...
        <form id="form-edit-product" class="body d-flex py-3" method="post" enctype="multipart/form-data" action="<%=request.getContextPath()%>/SaveAddProduct">
                                        ...
                                        <div>
                                            <div class="col-md-12" style="display: flex; flex-wrap: wrap">
                                                ...
                                                <div style="display: flex; flex-wrap: wrap" class="images">
                                                    <div id="contain-img-0" data-color="red" class="contain-color-image d-flex flex-wrap"></div>
                            ...
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <input id="totalValue" type="text" name="sold" class="form-control">
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label">Đã bán</label>
                                        <input id="totalSole" type="text"name="total-quantity" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
