! function(t, e) {
    ...
    var M = (o(z, [{
        ...
        C = (o(A, [{
            ...
            value: function(t, e) {
                var i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0,
                    ...
                    e = this.w;
                return t.unfilter(!0), M.isIE() && "radialBar" === e.config.chart.type || (r = Array.isArray(r) ? r[i] : r, t.filter(function(t) {
                    var e = M.isSafari() || M.isFirefox() || M.isIE() ? t.flood(r, n).composite(t.sourceAlpha, "in").offset(s, a).gaussianBlur(o) : t.flood(r, n).composite(t.sourceAlpha, "in").offset(s, a).gaussianBlur(o).merge(t.source);
                    t.blend(t.source, e)
        ...
        I = (o(k, [{
            ...
            value: function(t) {
                ...
                return !A || y.globals.resized || y.globals.dataChanged ? !y.globals.resized && y.globals.dataChanged || k.showDelayedElements() : k.animatePathsGradually(T(T({}, c), {}, {
                    speed: d
                })), y.globals.dataChanged && p && x && k.animatePathsGradually(T(T({}, c), {}, {
                    speed: g
                })), m
            }
        }, {
            ...
            value: function(t, e, i) {
                ...
                }), r = s) : "circle" !== i.shape && i.shape || (M.isNumber(e) || (e = o = 0), r = this.drawCircle(o, {
                    cx: t,
                    cy: e,
                    class: i.class || "",
                    stroke: i.pointStrokeColor,
            ...
            value: function(t, e) {
                ...
                "function" == typeof i.config.chart.events.dataPointMouseEnter && i.config.chart.events.dataPointMouseEnter(e, this.ctx, {
                    ...
                    dataPointIndex: o,
                    w: i
                }]), "none" !== i.config.states.active.filter.type && "true" === t.node.getAttribute("selected") || "none" === i.config.states.hover.filter.type || "none" === i.config.states.active.filter.type || i.globals.isTouchDevice || (i = i.config.states.hover.filter, a.applyFilter(t, s, i.type, i.value))
            }
        }, {
            key: "pathMouseLeave",
            value: function(t, e) {
            ...
            value: function(t, e, i, a) {
                ...
                o = i.bbox();
                return s || (o = i.node.getBoundingClientRect()), i.remove(), {
                    width: o.width,
                    height: o.height
                }
            }
        ...
        u = (o(y, [{
            ...
            value: function(t, e, i) {
                ...
                M.isNumber(n) && (null === t.x2 || void 0 === t.x2 ? (h = this.annoCtx.graphics.drawLine(n + t.offsetX, 0 + t.offsetY, n + t.offsetX, a.globals.gridHeight + t.offsetY, t.borderColor, d, t.borderWidth), e.appendChild(h.node), t.id && h.node.classList.add(t.id)) : (c = (t.x2 - s) / (r / a.globals.gridWidth), this.annoCtx.inversedReversedAxis && (c = (o - t.x2) / (r / a.globals.gridWidth)), (c = !("category" !== a.config.xaxis.type && !a.config.xaxis.convertedCatToNumeric || this.invertAxis || a.globals.dataFormatXNumeric) ? this.annoCtx.helpers.getStringX(t.x2) : c) < n && (r = n, n = c, c = r), (c = this.annoCtx.graphics.drawRect(n + t.offsetX, 0 + t.offsetY, c - n, a.globals.gridHeight + t.offsetY, 0, t.fillColor, t.opacity, 1, t.borderColor, d)).node.classList.add("apexcharts-annotation-rect"), c.attr("clip-path", "url(#gridRectMask".concat(a.globals.cuid, ")")), e.appendChild(c.node), t.id && c.node.classList.add(t.id)), c = "top" === t.label.position ? 4 : a.globals.gridHeight, a = this.annoCtx.graphics.getTextRects(l, parseFloat(t.label.style.fontSize)), (l = this.annoCtx.graphics.drawText({
                    ...
                    rel: i
                }), e.appendChild(l.node), this.annoCtx.helpers.setOrientations(t, i))
            }
        }, {
        ...
        f = (o(x, [{
            ...
            value: function(t, e, i) {
                ...
                for (var h = [], c = 0, d = 0; d <= t.seriesIndex; d++) {
                    ...
                    if (g)
                        for (var u = d + 1; u <= t.seriesIndex; u++) a.config.yaxis[u].seriesName === g && -1 === h.indexOf(g) && (c++, h.push(g))
                }
                ...
                a.config.yaxis[t.yAxisIndex] && a.config.yaxis[t.yAxisIndex].reversed && (o = p + parseFloat(t.label.style.fontSize) + t.marker.size, r = p), M.isNumber(s) && (p = {
                    pSize: t.marker.size,
                    ...
                    rel: i
                }), e.appendChild(p.node), t.customSVG.SVG && ((f = this.annoCtx.graphics.group({
                ...
                }), f.node.innerHTML = t.customSVG.SVG, e.appendChild(f.node)), t.image.path && (e = t.image.width || 20, f = t.image.height || 20, this.annoCtx.addImage({
    ...
    var X = {
        ...
        Y = (o(Ee, [{
            ...
            value: function(t) {
                ...
                }), t = M.listToArray(t), Array.prototype.forEach.call(t, function(t) {
        ...
        F = (o(Xe, [{
            ...
            value: function(t) {
                ...
                return -1 === o.indexOf("rgb") ? o.length < 9 && (l = M.hexToRgba(o, n)) : -1 < o.indexOf("rgba") && (n = M.getOpacityFromRGBA(o)), t.opacity && (n = t.opacity), "pattern" === r && (i = this.handlePatternFill(i, o, n, l)), "gradient" === r && (a = this.handleGradientFill(o, n, this.seriesIndex)), i = "image" === r ? (o = s.fill.image.src, s = t.patternID || "", this.clippedImgArea({
                    opacity: n,
            ...
            value: function(t, e, i) {
                var a = this.w.config,
                    ...
                    l = t,
                    h = void 0 === a.fill.gradient.opacityFrom ? e : Array.isArray(a.fill.gradient.opacityFrom) ? a.fill.gradient.opacityFrom[i] : a.fill.gradient.opacityFrom; - 1 < l.indexOf("rgba") && (h = M.getOpacityFromRGBA(l));
                ...
                return void 0 === a.fill.gradient.gradientToColors || 0 === a.fill.gradient.gradientToColors.length ? c = "dark" === a.fill.gradient.shade ? r.shadeColor(-1 * parseFloat(a.fill.gradient.shadeIntensity), -1 < t.indexOf("rgb") ? M.rgb2hex(t) : t) : r.shadeColor(parseFloat(a.fill.gradient.shadeIntensity), -1 < t.indexOf("rgb") ? M.rgb2hex(t) : t) : a.fill.gradient.gradientToColors[s.seriesNumber] ? -1 < (c = r = a.fill.gradient.gradientToColors[s.seriesNumber]).indexOf("rgba") && (e = M.getOpacityFromRGBA(r)) : c = t, a.fill.gradient.inverseColors && (t = l, l = c, c = t), -1 < l.indexOf("rgb") && (l = M.rgb2hex(l)), -1 < c.indexOf("rgb") && (c = M.rgb2hex(c)), o.drawGradient(n, l, c, h, e, s.size, a.fill.gradient.stops, a.fill.gradient.colorStops, i)
            }
        }]), Xe),
        R = (o(ze, [{
            ...
            value: function(t, e, i, a) {
                var s = 4 < arguments.length && void 0 !== arguments[4] && arguments[4],
                    ...
                    l = null,
                    h = new I(this.ctx);
                if ((0 < o.globals.markers.size[e] || s) && (l = h.group({
                        class: s ? "" : "apexcharts-series-markers"
                    })).attr("clip-path", "url(#gridRectMarkerMask".concat(o.globals.cuid, ")")), Array.isArray(n.x))
            ...
            value: function(t, e) {
                ...
                return null !== i && a.discrete.length && a.discrete.map(function(t) {
                    t.seriesIndex === e && t.dataPointIndex === i && (s.pointStrokeColor = t.strokeColor, s.pointFillColor = t.fillColor, o = t.size, s.pointShape = t.shape)
                }), {
                    pSize: o,
                    pRadius: a.radius,
                    ...
                    shape: s.pointShape || (Array.isArray(a.shape) ? a.shape[e] : a.shape),
                    class: t,
        ...
        H = (o(Ie, [{
            ...
            value: function(t, e, i, a, s, o, r) {
                ...
                if ("circle" === x.shape ? n = f.drawCircle(i) : "square" !== x.shape && "rect" !== x.shape || (n = f.drawRect(0, 0, x.width - x.pointStrokeWidth / 2, x.height - x.pointStrokeWidth / 2, x.pRadius)), h.config.series[c].data[o] && h.config.series[c].data[o].fillColor && (u = h.config.series[c].data[o].fillColor), n.attr({
                    ...
                    }), h.config.chart.dropShadow.enabled && (l = h.config.chart.dropShadow, g.dropShadow(n, l, s)), !this.initialAnim || h.globals.dataChanged || h.globals.resized ? h.globals.animationEnded = !0 : (l = h.config.chart.animations.speed, d.animateMarker(n, 0, "circle" === x.shape ? a : {
                        width: x.width,
                        height: x.height
                    }, l, h.globals.easing, function() {
                ...
                }), g.setSelectionFilter(n, s, o), p.addEvents(n), n.node.classList.add("apexcharts-marker"), n
            }
        }, {
        ...
        D = (o(Me, [{
            ...
            value: function(t, e, i, a, s, o, r) {
                var n = this.w,
                    l = !1,
                    h = new I(this.ctx).getTextRects(i, r),
                    c = h.width,
                    i = h.height;
        ...
        N = (o(Te, [{
            ...
            value: function(t) {
                ...
                var g = new D(this.barCtx.ctx),
                    u = new I(this.barCtx.ctx),
                    p = h.formatter,
                    f = null,
        ...
        O = (o(Pe, [{
            ...
            value: function() {
                ...
                if (1 < s.config.series.length)
                    for (var i = s.config.series.map(function(t, e) {
                            var i = !1;
                ...
                n.globals.previousPaths = [], ["line", "area", "bar", "rangebar", "candlestick", "radar"].forEach(function(t) {
                    for (var e = n.globals.dom.baseEl.querySelectorAll(".apexcharts-".concat(t, "-series .apexcharts-series")), i = 0; i < e.length; i++) ! function(t, e, i) {
                        for (var a, s = t[e].childNodes, o = {
                            ...
                            }, r = 0; r < s.length; r++) s[r].hasAttribute("pathTo") && (a = s[r].getAttribute("pathTo"), o.paths.push({
                            d: a
                        }));
        ...
        B = (o(Ce, [{
            ...
            value: function(t, e) {
                ...
                for (var r = 0, n = 0; r < t.length; r++, n++) {
                    ...
                    for (var w = a.group({
                        ...
                        this.isHorizontal ? (C = this.drawBarPaths(T(T({}, L), {}, {
                            barHeight: p,
                            zeroW: m,
                            yDivision: b
                        })), f = this.series[r][A] / this.invertedYRatio) : (C = this.drawColumnPaths(T(T({}, L), {}, {
                            xDivision: v,
                            barWidth: f,
                            zeroH: y
            ...
            value: function(t) {
                var e = t.indexes,
                    ...
                    d = this.barHelpers.getXForValue(this.series[h][c], s),
            ...
            value: function(t) {
                ...
                var g = i + s * this.visibleI,
                    u = this.barHelpers.getYForValue(this.series[c][d], o),
        ...
        V = (o(Se, [{
            ...
            value: function(t, e) {
                var i = 30;
                return t = M.monthMod(t), !0 == -1 < this.months30.indexOf(t) ? 2 === t && (i = this.isLeapYear(e) ? 29 : 28) : (this.months31.indexOf(t), i = 31), i
            }
        }]), Se),
        G = function() {
            n(e, B);
            ...
            return o(e, [{
                ...
                value: function(t, e) {
                    ...
                    for (var s = a.group({
                        ...
                        var r, n = void 0,
                            ...
                            c = a.group({
                                class: "apexcharts-series",
                                seriesName: M.escapeString(i.globals.seriesNames[h]),
                                rel: o + 1,
                                "data:realIndex": h
                            });
                        ...
                        for (var g = u.barWidth, p = u.xDivision, f = u.zeroH, x = a.group({
                            ...
                            var v = this.barHelpers.getStrokeWidth(o, m, h),
                                y = this.seriesRangeStart[o][m],
                            ...
                            if (d = u.barHeight, this.isHorizontal) {
                                ...
                                this.isTimelineBar && i.config.series[o].data[m].x && (d = (P = this.detectOverlappingBars({
                                    i: o,
                                    j: m,
                                    barYPosition: A,
                                    srty: L,
                                    ...
                                    yDivision: C,
                                    initPositions: u
                                })).barHeight, A = P.barYPosition), g = (k = this.drawRangeBarPaths(T({
                                    indexes: {
                                        i: o,
                                        j: m,
                                        realIndex: h
                            ...
                            } else d = (k = this.drawRangeColumnPaths(T({
                                indexes: {
                                    i: o,
                                    j: m,
                                    realIndex: h
                ...
                value: function(t) {
                    ...
                    return {
                        barYPosition: a = -1 < i && !l.config.plotOptions.bar.rangeBarOverlap && -1 < (h = l.globals.seriesRangeBarTimeline[e][i].overlaps).indexOf(c) ? (o = n.barHeight / h.length) * this.visibleI + r * (100 - parseInt(this.barOptions.barHeight, 10)) / 100 / 2 + o * (this.visibleI + h.indexOf(c)) + r * t : a,
                        barHeight: o
                    }
                }
            }, {
                ...
                value: function(t) {
                    var e = t.indexes,
                        ...
                        l = t.zeroW,
                        h = this.w,
                        t = l + a / this.invertedYRatio,
                        a = l + s / this.invertedYRatio,
                        s = Math.abs(a - t),
        ...
        j = (o(ke, [{
            ...
            value: function(i, t) {
                var a = new E;
                (void 0 === i.yaxis || !i.yaxis || Array.isArray(i.yaxis) && 0 === i.yaxis.length) && (i.yaxis = {}), i.yaxis.constructor !== Array && window.Apex.yaxis && window.Apex.yaxis.constructor !== Array && (i.yaxis = M.extend(i.yaxis, window.Apex.yaxis)), i.yaxis.constructor !== Array ? i.yaxis = [M.extend(a.yAxis, i.yaxis)] : i.yaxis = M.extendArray(i.yaxis, a.yAxis);
                var e = !1;
        ...
        q = (o(ye, [{
            key: "init",
            value: function() {
                var t = new j(this.opts).init({
                    responsiveOverride: !1
                });
                return {
                    config: t,
                    globals: (new U).init(t)
                }
            }
        }]), ye),
        Z = (o(ve, [{
            ...
            value: function(t, e) {
                ...
                for (var r = 0; r < t[e].data.length; r++) void 0 !== t[e].data[r].y && (Array.isArray(t[e].data[r].y) ? this.twoDSeries.push(M.parseNumber(t[e].data[r].y[t[e].data[r].y.length - 1])) : this.twoDSeries.push(M.parseNumber(t[e].data[r].y))), void 0 !== t[e].data[r].goals && Array.isArray(t[e].data[r].goals) ? (void 0 === this.seriesGoals[e] && (this.seriesGoals[e] = []), this.seriesGoals[e].push(t[e].data[r].goals)) : (void 0 === this.seriesGoals[e] && (this.seriesGoals[e] = []), this.seriesGoals[e].push(null));
        ...
        $ = (o(me, [{
            ...
            value: function(t, e, i) {
                var a = this.w;
                return t = M.isNumber(t) ? 0 !== a.globals.yValueDecimal ? t.toFixed(void 0 !== e.decimalsInFloat ? e.decimalsInFloat : a.globals.yValueDecimal) : a.globals.maxYArr[i] - a.globals.minYArr[i] < 5 ? t.toFixed(1) : t.toFixed(0) : t
            }
        }, {
            ...
            value: function() {
                ...
                return s.globals.xaxisTooltipFormatter = function(t) {
                    ...
                    if (M.isNumber(t)) {
                        ...
                        if (M.isNumber(s.config.xaxis.decimalsInFloat)) return t.toFixed(s.config.xaxis.decimalsInFloat);
        ...
        Q = (o(xe, [{
            ...
            value: function(n) {
                ...
                return new Promise(function(e) {
                    var t = l.w,
                        i = n ? n.scale || n.width / t.globals.svgWidth : 1;
                    l.cleanup();
                    ...
                    window.canvg && M.isIE11() ? ((s = window.canvg.Canvg.fromString(o, t, {
                        ignoreClear: !0,
                        ignoreDimensions: !0
                    })).start(), i = a.msToBlob(), s.stop(), e({
                        blob: i
                    })) : (t = "data:image/svg+xml," + encodeURIComponent(t), (r = new Image).crossOrigin = "anonymous", r.onload = function() {
                        var t;
                        o.drawImage(r, 0, 0), a.msToBlob ? (t = a.msToBlob(), e({
                            blob: t
                        })) : (t = a.toDataURL("image/png"), e({
                            imgURI: t
                        }))
                    }, r.src = t)
                })
                        ...
                        if (g.length && 0 === e && u.push(g.join(c)), t.data && t.data.length)
                            for (var i = 0; i < t.data.length; i++) {
                                ...
                                s = (s = i, r = o = void 0, n = "", d.globals.axisCharts ? ("category" !== d.config.xaxis.type && !d.config.xaxis.convertedCatToNumeric || (n = d.globals.isBarHorizontal ? (o = d.globals.yLabelFormatters[0], r = new O(l.ctx).getActiveConfigSeriesIndex(), o(d.globals.labels[s], {
                                    ...
                                    dataPointIndex: s,
                                    w: d
                                })) : f.getLabel(d.globals.labels, d.globals.timescaleLabels, 0, s).text), "datetime" === d.config.xaxis.type && (d.config.xaxis.categories.length ? n = d.config.xaxis.categories[s] : d.config.labels.length && (n = d.config.labels[s]))) : n = d.config.labels[s], Array.isArray(n) && (n = n.join(" ")), M.isNumber(n) ? n : n.split(c).join(""));
                                if (s || (p.isFormatXY() ? s = h[e].data[i].x : p.isFormat2DArray() && (s = h[e].data[i] ? h[e].data[i][0] : "")), 0 === e) {
                                    g.push((n = s, "datetime" === d.config.xaxis.type && 10 <= String(n).length ? d.config.chart.toolbar.export.csv.dateFormatter(s) : M.isNumber(s) ? s : s.split(c).join("")));
        ...
        K = (o(fe, [{
            ...
            value: function() {
                ...
                return void 0 !== s.config.xaxis.title.text && (d = o.group({
        ...
        tt = (o(pe, [{
            ...
            value: function(t) {
                ...
                if ((h.config.grid.xaxis.lines.show || h.config.xaxis.axisTicks.show) && (e = h.globals.padHorizontal, t = h.globals.gridHeight, h.globals.timescaleLabels.length ? function(t) {
                    ...
                    for (var c = 0; c < r + (this.isTimelineBar ? 1 : 0); c++) this._drawGridLine({
                        x1: 0,
                        y1: a,
                        x2: o,
                        y2: s,
                        parent: this.elgridLinesH
                    }), s = a += h.globals.gridHeight / (this.isTimelineBar ? r : i)
                }
            }
        }, {
        ...
        et = (o(ue, [{
            ...
            value: function(t, e) {
                var i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 10,
                    ...
                    o = this.w,
                    r = Math.abs(e - t);
                if ("dataPoints" === (i = this._adjustTicksForSmallRange(i, a, r)) && (i = o.globals.dataPoints - 1), t === Number.MIN_VALUE && 0 === e || !M.isNumber(t) && !M.isNumber(e) || t === Number.MIN_VALUE && e === -Number.MAX_VALUE) return e = i, this.linearScale(t = 0, e, i);
            ...
            value: function(t, e, i) {
                var a = t;
                return void 0 !== e && this.w.config.yaxis[e].labels.formatter && void 0 === this.w.config.yaxis[e].tickAmount && (e = this.w.config.yaxis[e].labels.formatter(1), M.isNumber(Number(e)) && !M.isFloat(e) && (a = Math.ceil(i))), a < t ? a : t
            }
        }, {
            ...
            value: function(t, e, i) {
                ...
                var r = Math.abs(i - e);
                o.logarithmic && r <= 5 && (a.invalidLogScale = !0), o.logarithmic && 5 < r ? (a.allSeriesCollapsed = !1, a.yAxisScale[t] = this.logarithmicScale(i)) : i !== -Number.MAX_VALUE && M.isNumber(i) ? (a.allSeriesCollapsed = !1, void 0 === o.min && void 0 === o.max || o.forceNiceScale ? (s = void 0 === s.yaxis[t].max && void 0 === s.yaxis[t].min || s.yaxis[t].forceNiceScale, a.yAxisScale[t] = this.niceScale(e, i, o.tickAmount || (r < 5 && 1 < r ? r + 1 : 5), t, s)) : a.yAxisScale[t] = this.linearScale(e, i, o.tickAmount, t)) : a.yAxisScale[t] = this.linearScale(0, 5, 5)
            }
        }, {
            key: "setXScale",
            value: function(t, e) {
                var i = this.w,
                    ...
                    s = i.config.xaxis,
                    i = Math.abs(e - t);
                return e !== -Number.MAX_VALUE && M.isNumber(e) ? a.xAxisScale = this.linearScale(t, e, s.tickAmount || (i < 5 && 1 < i ? i + 1 : 5), 0) : a.xAxisScale = this.linearScale(0, 5, 5), a.xAxisScale
            }
        }, {
            ...
            value: function(t) {
                ...
                for (var d = t; d < a; d++) {
                    ...
                    for (var g = 0; g < o.series[d].length; g++) {
                        ...
                        }), M.isFloat(u) && (u = M.noExponents(u), o.yValueDecimal = Math.max(o.yValueDecimal, u.toString().split(".")[1].length)), n > h[d][g] && h[d][g] < 0 && (n = h[d][g])) : o.hasNullValues = !0
                    }
                }
                return "rangeBar" === s.chart.type && o.seriesRangeStart.length && o.isBarHorizontal && "datetime" === s.xaxis.type && (n = e), "bar" === s.chart.type && (n < 0 && r < 0 && (r = 0), n === Number.MIN_VALUE && (n = 0)), {
                    minY: n,
                    maxY: r,
                    lowestY: e,
                    highestY: i
            ...
            value: function() {
                ...
                if (i.isXNumeric && function() {
                        for (var t = 0; t < i.series.length; t++)
                            if (i.labels[t])
                                for (var e = 0; e < i.labels[t].length; e++) null !== i.labels[t][e] && M.isNumber(i.labels[t][e]) && (i.maxX = Math.max(i.maxX, i.labels[t][e]), i.initialMaxX = Math.max(i.maxX, i.labels[t][e]), i.minX = Math.min(i.minX, i.labels[t][e]), i.initialMinX = Math.min(i.minX, i.labels[t][e]))
            ...
            value: function() {
                ...
                if (t.series.length)
                    for (var a = 0; a < t.series[t.maxValsInArrayIndex].length; a++)
                        for (var s = 0, o = 0, r = 0; r < t.series.length; r++) null !== t.series[r][a] && M.isNumber(t.series[r][a]) && (0 < t.series[r][a] ? s = s + parseFloat(t.series[r][a]) + 1e-4 : o += parseFloat(t.series[r][a])), r === t.series.length - 1 && (e.push(s), i.push(o));
        ...
        at = (o(de, [{
            ...
            value: function(s) {
                ...
                void 0 !== r.config.yaxis[s].title.text && (i = n.group({
                    class: "apexcharts-yaxis-title"
                }), a = 0, r.config.yaxis[s].opposite && (a = r.globals.translateYAxisX[s]), v = n.drawText({
                    x: a,
            ...
            value: function() {
                ...
                (t = M.listToArray(t)).forEach(function(t, e) {
                    var i, a, s = o.config.yaxis[e];
                    s && void 0 !== s.labels.align && (i = o.globals.dom.baseEl.querySelector(".apexcharts-yaxis[rel='".concat(e, "'] .apexcharts-yaxis-texts-g")), a = o.globals.dom.baseEl.querySelectorAll(".apexcharts-yaxis[rel='".concat(e, "'] .apexcharts-yaxis-label")), a = M.listToArray(a), e = i.getBoundingClientRect(), "left" === s.labels.align ? (a.forEach(function(t, e) {
        ...
        rt = (o(ne, [{
            ...
            value: function() {
                ...
                t.config.xaxis.crosshairs.show && ("gradient" === o && (s = e.drawGradient("vertical", r, n, l, h, null, c, null)), h = e.drawRect(), 1 === t.config.xaxis.crosshairs.width && (h = e.drawLine()), c = t.globals.gridHeight, (!M.isNumber(c) || c < 0) && (c = 0), e = t.config.xaxis.crosshairs.width, (!M.isNumber(e) || e < 0) && (e = 0), h.attr({
        ...
        nt = (o(re, [{
            ...
            value: function(t) {
                ...
                0 !== i.responsive.length && ((s = i.responsive.slice()).sort(function(t, e) {
                    ...
                    if (e < i) {
                        e = P.extendArrayProps(o, n.globals.initialConfig, n), t = M.extend(e, t);
                        t = M.extend(n.config, t), r.overrideResponsiveOptions(t)
                    } else
                        for (var a = 0; a < s.length; a++) i < s[a].breakpoint && (t = P.extendArrayProps(o, s[a].options, n), t = M.extend(n.config, t), r.overrideResponsiveOptions(t))
                }, t ? (i = P.extendArrayProps(o, t, n), i = M.extend(n.config, i), e(i = M.extend(i, t))) : e({}))
            }
        }, {
            ...
            value: function() {
                ...
                return h.config.yaxis.map(function(t, e) {
                    ...
                    !g.isYAxisHidden(e) && t.labels.show && void 0 !== t.labels.minWidth && (n = t.labels.minWidth), !g.isYAxisHidden(e) && t.labels.show && r.result.length ? (s = h.globals.yLabelFormatters[e], i = r.niceMin === Number.MIN_VALUE ? 0 : r.niceMin, void 0 !== (r = i = s(a = String(i).length > String(r.niceMax).length ? i : r.niceMax, {
                        ...
                        dataPointIndex: -1,
                        w: h
                    })) && 0 !== i.length || (i = a), h.globals.isBarHorizontal && (d = 0, o = h.globals.labels.slice(), i = s(i = M.getLargestStringFromArr(o), {
                        seriesIndex: e,
                        dataPointIndex: -1,
                        w: h
        ...
        xt = (o(Jt, [{
            ...
            value: function() {
                ...
                if ((t.legend.showForSingleSeries && 1 === e.series.length || this.isBarsDistributed || 1 < e.series.length || !e.axisCharts) && t.legend.show) {
                    ...
                    this.drawLegends(), M.isIE11() ? document.getElementsByTagName("head")[0].appendChild(this.legendHelpers.getLegendStyles()) : this.legendHelpers.appendToForeignObject(), "bottom" === t.legend.position || "top" === t.legend.position ? this.legendAlignHorizontal() : "right" !== t.legend.position && "left" !== t.legend.position || this.legendAlignVertical()
                }
            }
        }, {
            key: "drawLegends",
        ...
        bt = (o($t, [{
            ...
            value: function(t) {
                this.elMenuItems = [], t.appendChild(this.elMenu), I.setAttrs(this.elMenu, {
            ...
            value: function(t, e) {
                ...
                }, t = M.clone(a.globals.initialConfig.yaxis), a.config.chart.zoom.autoScaleYaxis && (t = new et(this.ctx).autoScaleY(this.ctx, t, {
                    xaxis: i
                })), a.config.chart.group || (e.yaxis = t), this.w.globals.zoomed = !0, this.ctx.updateHelpers._updateOptions(e, !1, this.w.config.chart.animations.dynamicAnimation.enabled), this.zoomCallback(i, t)) : this.handleZoomReset()
            }
        }, {
            key: "zoomCallback",
            value: function(t, e) {
            ...
            return o(a, [{
                ...
                value: function(t, e) {
                    ...
                    r.contains("apexcharts-selection-rect") || r.contains("apexcharts-legend-marker") || r.contains("apexcharts-legend-text") || e.target.parentNode.classList.contains("apexcharts-toolbar") || (a.clientX = ("touchmove" === e.type || "touchstart" === e.type ? e.touches[0] : "touchend" === e.type ? e.changedTouches[0] : e).clientX, a.clientY = ("touchmove" === e.type || "touchstart" === e.type ? e.touches[0] : "touchend" === e.type ? e.changedTouches[0] : e).clientY, "mousedown" === e.type && 1 === e.which && (r = a.gridRect.getBoundingClientRect(), a.startX = a.clientX - r.left, a.startY = a.clientY - r.top, a.dragged = !1, a.w.globals.mousedown = !0), ("mousemove" === e.type && 1 === e.which || "touchmove" === e.type) && (a.dragged = !0, i.globals.panEnabled ? (i.globals.selection = null, a.w.globals.mousedown && a.panDragging({
                        ...
                        context: a,
                        zoomtype: o
                    }))), "mouseup" !== e.type && "touchend" !== e.type && "mouseleave" !== e.type || (e = a.gridRect.getBoundingClientRect(), a.w.globals.mousedown && (a.endX = a.clientX - e.left, a.endY = a.clientY - e.top, a.dragX = Math.abs(a.endX - a.startX), a.dragY = Math.abs(a.endY - a.startY), (i.globals.zoomEnabled || i.globals.selectionEnabled) && a.selectionDrawn({
                        context: a,
                        zoomtype: o
                    }), i.globals.panEnabled && i.config.xaxis.convertedCatToNumeric && a.delayedPanScrolled()), i.globals.zoomEnabled && a.hideSelectionRect(this.selectionRect), a.dragged = !1, a.w.globals.mousedown = !1), this.makeSelectionRectDraggable())
                }
            }, {
                ...
                value: function(t) {
                    ...
                    !this.dragged && null === n.globals.selection || (r = {
                        transform: "translate(" + (void 0 === o ? 0 : o) + ", " + (void 0 === r ? 0 : r) + ")"
                    }, n.globals.zoomEnabled && this.dragged && (l.attr({
                        x: e,
                        y: i,
                        width: a = a < 0 ? 1 : a,
                        height: s,
                ...
                value: function(t) {
                    ...
                    }), s.dragged && (10 < s.dragX || 10 < s.dragY) && e !== c && (a.globals.zoomEnabled ? (n = M.clone(a.globals.initialConfig.yaxis), r = M.clone(a.globals.initialConfig.xaxis), a.globals.zoomed = !0, a.config.xaxis.convertedCatToNumeric && (e = Math.floor(e), c = Math.floor(c), e < 1 && (e = 1, c = a.globals.dataPoints), c - e < 2 && (c = e + 1)), "xy" !== i && "x" !== i || (r = {
                        min: e,
                        max: c
                    }), "xy" !== i && "y" !== i || n.forEach(function(t, e) {
                        n[e].min = g[e], n[e].max = d[e]
                    }), a.config.chart.zoom.autoScaleYaxis && (n = new et(s.ctx).autoScaleY(s.ctx, n, {
                        xaxis: r
                    })), !t || (l = t.getBeforeZoomRange(r, n)) && (r = l.xaxis || r, n = l.yaxis || n), l = {
                        xaxis: r
                    }, a.config.chart.group || (l.yaxis = n), s.ctx.updateHelpers._updateOptions(l, !1, s.w.config.chart.animations.dynamicAnimation.enabled), "function" == typeof a.config.chart.events.zoomed && t.zoomCallback(r, n)) : a.globals.selectionEnabled && (h = null, c = {
                        min: e,
                        max: c
                    }, "xy" !== i && "y" !== i || (h = M.clone(a.config.yaxis)).forEach(function(t, e) {
                ...
                value: function(t, e) {
                    ...
                    i.config.chart.zoom.autoScaleYaxis && (s = new et(this.ctx).autoScaleY(this.ctx, s, {
                        xaxis: n
                    }));
                    n = {
                        xaxis: {
        ...
        vt = (o(Zt, [{
            ...
            value: function(t) {
                ...
                }), o.globals.isXNumeric && (t = (i = this.closestInMultiArray(a, s, h, l)).index, n = i.j, null !== t && (h = o.globals.seriesXvalues[t], n = (i = this.closestInArray(a, h)).index)), o.globals.capturedSeriesIndex = null === t ? -1 : t, (!n || n < 1) && (n = 0), o.globals.isBarHorizontal ? o.globals.capturedDataPointIndex = e : o.globals.capturedDataPointIndex = n, {
                    capturedSeries: t,
        ...
        wt = (o(Ut, [{
            ...
            value: function(t) {
                ...
                null !== e.ycrosshairs && I.setAttrs(e.ycrosshairs, {
                    y1: t,
                    y2: t
                }), null !== e.ycrosshairsHidden && I.setAttrs(e.ycrosshairsHidden, {
                    y1: t,
                    y2: t
                })
            }
        ...
        kt = (o(jt, [{
            ...
            value: function() {
                for (var t = this.w.globals.dom.baseEl.querySelectorAll(".apexcharts-series:not(.apexcharts-series-collapsed) .apexcharts-marker"), e = 0; e < t.length; e++) {
                    ...
                    M.isNumber(i) && 0 <= i ? t[e].setAttribute("r", i) : t[e].setAttribute("r", 0)
                }
            }
        }]), jt),
        At = (o(_t, [{
            ...
            value: function(t) {
                var e, i, a, s, o, r = t.e,
                    ...
                    c = this.w,
                    d = this.ttCtx;
                return r.target.classList.contains("apexcharts-marker") && (o = parseInt(n.paths.getAttribute("cx"), 10), e = parseInt(n.paths.getAttribute("cy"), 10), i = parseFloat(n.paths.getAttribute("val")), s = parseInt(n.paths.getAttribute("rel"), 10), t = parseInt(n.paths.parentNode.parentNode.parentNode.getAttribute("rel"), 10) - 1, d.intersect && (a = M.findAncestor(n.paths, "apexcharts-series")) && (t = parseInt(a.getAttribute("data:realIndex"), 10)), d.tooltipLabels.drawSeriesTexts({
                    ttItems: n.ttItems,
                    i: t,
                    j: s,
        ...
        Lt = function() {
            ...
            return o(e, [{
                ...
                value: function(m, v) {
                    ...
                    for (var k = this.graphics.group({
                            class: "apexcharts-bar-series apexcharts-plot-series"
                        }), A = 0, S = 0, i = 0, a = 0; i < m.length; i++, a++) ! function(t, e) {
                        var i, a, s, o, r = [],
                            n = [],
                        ...
                        var h = y.graphics.group({
                            class: "apexcharts-series",
                            seriesName: M.escapeString(w.globals.seriesNames[l]),
                            rel: t + 1,
                            "data:realIndex": l
                        });
                        ...
                        for (var p = 0; p < w.globals.dataPoints; p++) {
                            var f = y.barHelpers.getStrokeWidth(t, p, l),
                                ...
                                b = null;
                            y.isHorizontal ? (b = y.drawStackedBarPaths(T(T({}, x), {}, {
                                zeroW: o,
                                barHeight: d,
                                yDivision: a
                            })), g = y.series[t][p] / y.invertedYRatio) : (b = y.drawStackedColumnPaths(T(T({}, x), {}, {
                                xDivision: i,
                                barWidth: g,
                                zeroH: s
                ...
                value: function(x, s) {
                    ...
                    for (var y = o.group({
                        ...
                        var n = void 0,
                            ...
                            c = o.group({
                                class: "apexcharts-series",
                                seriesName: M.escapeString(m.globals.seriesNames[h]),
                                rel: r + 1,
                                "data:realIndex": h
                            });
        ...
        Tt = (o(Bt, [{
            ...
            value: function(t, e, i, a) {
                ...
                a = i.color, r = new M;
                return {
                    color: a = s.config.plotOptions[t].enableShades ? "dark" === this.w.config.theme.mode ? M.hexToRgba(r.shadeColor(-1 * o, i.color), s.config.fill.opacity) : M.hexToRgba(r.shadeColor(o, i.color), s.config.fill.opacity) : a,
                    colorProps: i
                }
            }
        }, {
            ...
            value: function(t) {
                ...
                return l.enabled && (d = h.group({
                    class: "apexcharts-data-labels"
                }), t = l.offsetX, h = l.offsetY, t = i + t, h = a + parseFloat(l.style.fontSize) / 3 + h, c.plotDataLabelsText({
                    x: t,
                    y: h,
                    text: e,
                    i: s,
                ...
                for (var h = n ? 0 : l.length - 1; n ? h < l.length : 0 <= h; n ? h++ : h--) {
                    ...
                    for (var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, p = 0; p < l[h].length; p++) {
                        ...
                        f.attr({
                            cx: g,
                            cy: r
                        }), f.node.classList.add("apexcharts-heatmap-rect"), d.add(f), f.attr({
                            fill: x,
                            i: h,
                            index: h,
                            j: p,
                            ...
                            color: x
                        }), this.helpers.addListeners(f), e.config.chart.animations.enabled && !e.globals.dataChanged && (m = 1, e.globals.resized || (m = e.config.chart.animations.speed), this.animateHeatMap(f, g, r, s, o, m)), e.globals.dataChanged && (v = 1, this.dynamicAnim.enabled && e.globals.shouldAnimate && (v = this.dynamicAnim.speed, m = e.globals.previousPaths[h] && e.globals.previousPaths[h][p] && e.globals.previousPaths[h][p].color || "rgba(255, 255, 255, 0)", this.animateHeatColor(f, M.isColorHex(m) ? m : M.rgb2hex(m), M.isColorHex(x) ? x : M.rgb2hex(x), v)));
        ...
        zt = (o(Nt, [{
            ...
            value: function(t) {
                ...
                for (var s = 0, o = 0; o < t.length; o++) s += M.negToZero(t[o]);
                var r = [],
                    n = a.group();
                ...
                }), n.add(b), this.ret.add(n), this.donutDataLabels.show && (x = this.renderInnerDataLabels(this.donutDataLabels, {
            ...
            value: function(t, e) {
                var i, a = this.w,
                    ...
                    l = (this.initialAngle, this.initialAngle, this.initialAngle),
                    h = this.initialAngle;
                this.strokeWidth = a.config.stroke.show ? a.config.stroke.width : 0;
                for (var c = 0; c < t.length; c++) {
                    var d = o.group({
                        class: "apexcharts-series apexcharts-pie-series",
                        seriesName: M.escapeString(a.globals.seriesNames[c]),
                        rel: c + 1,
                        "data:realIndex": c
                    });
                    n.add(d);
                    ...
                    "pie" === this.chartType || "polarArea" === this.chartType ? p = M.polarToCartesian(this.centerX, this.centerY, a.globals.radialSize / 1.25 + a.config.plotOptions.pie.dataLabels.offset, (i + u / 2) % this.fullAngle) : "donut" === this.chartType && (p = M.polarToCartesian(this.centerX, this.centerY, (a.globals.radialSize + this.donutSize) / 2 + a.config.plotOptions.pie.dataLabels.offset, (i + u / 2) % this.fullAngle)), d.add(f);
                    var x = 0;
                    !this.initialAnim || a.globals.resized || a.globals.dataChanged ? this.animBeginArr.push(0) : (0 == (x = u / this.fullAngle * a.config.chart.animations.speed) && (x = 1), this.animDur = x + this.animDur, this.animBeginArr.push(this.animDur)), this.dynamicAnim && a.globals.dataChanged ? this.animatePaths(f, {
                        ...
                        seriesIndex: c,
                        w: a
                    })), u = a.globals.dataLabels.style.colors[c], p = o.group({
                        class: "apexcharts-datalabels"
                    }), f = o.drawText({
                        x: d,
                        y: x,
            ...
            value: function(t) {
                ...
                "true" !== t.attr("data:pieClicked") ? (i = i.globals.dom.baseEl.getElementsByClassName("apexcharts-pie-area"), Array.prototype.forEach.call(i, function(t) {
                    ...
                    angle: i,
                    size: a
                }), 360 !== i && t.plot(e)) : (t.attr({
                    "data:pieClicked": "false"
                }), this.revertDataLabelsInner(t.node, this.donutDataLabels), e = t.attr("data:pathOrig"), t.attr({
                    d: e
                }))
            }
        }, {
            ...
            value: function(t) {
                ...
                var l = Math.PI * (n - 90) / 180,
                    ...
                    n = M.polarToCartesian(e.centerX, e.centerY, e.donutSize, n),
                    o = M.polarToCartesian(e.centerX, e.centerY, e.donutSize, o),
                    a = 180 < a ? 1 : 0,
            ...
            value: function(i) {
                ...
                if (0 !== o.strokeWidth) {
                    for (var e = [], r = 360 / t.globals.series.length, n = 0; n < t.globals.series.length; n++) e.push(M.polarToCartesian(this.centerX, this.centerY, t.globals.radialSize, t.config.plotOptions.pie.startAngle + r * n));
        ...
        Xt = (o(Dt, [{
            ...
            value: function(t) {
                ...
                return this.yaxisLabels = this.graphics.group({
                    ...
                    var e = t.length === g.globals.dataPoints,
                        o = d.graphics.group().attr({
                            class: "apexcharts-series",
                            "data:longestSeries": e,
                            seriesName: M.escapeString(g.globals.seriesNames[s]),
                            rel: s + 1,
                            "data:realIndex": s
                        });
                    ...
                    for (var n = 0; n < i.linePathsTo.length; n++) {
                        var l = d.graphics.renderPaths(T(T({}, a), {}, {
                        ...
                        var h = u.fillPath({
                            ...
                            c = d.graphics.renderPaths(T(T({}, a), {}, {
                        ...
                        g.config.chart.dropShadow.enabled && (l = new C(d.ctx), h = g.config.chart.dropShadow, l.dropShadow(c, Object.assign({}, h, {
                            noUserSpaceOnUse: !0
                        }), s)), o.add(c)
                    }
                    t.forEach(function(t, e) {
                    ...
                    parent: a
                }), g.config.xaxis.labels.show && (t = this.drawXAxisTexts(), a.add(t)), p.forEach(function(t) {
                    a.add(t)
            ...
            value: function(t) {
                ...
                n.forEach(function(t, a) {
                    var t = M.getPolygonPos(t, o.dataPointsLen),
                        s = "";
                    t.forEach(function(t, e) {
                        var i;
            ...
            value: function() {
                var o = this,
                    ...
                    h = M.getPolygonPos(this.size, this.dataPointsLen);
                ...
                value: function(t) {
                    ...
                    for (var d = !1, g = (d = e.config.plotOptions.radialBar.inverseOrder ? !0 : d) ? t.series.length - 1 : 0; d ? 0 <= g : g < t.series.length; d ? g-- : g++) {
                        var u = i.group({
                            ...
                            seriesName: M.escapeString(e.globals.seriesNames[g])
                        });
                        o.add(u), u.attr({
                            rel: g + 1,
                            "data:realIndex": g
                        ...
                        var p = a.fillPath({
                            ...
                            f = this.startAngle,
                            x = void 0,
                            b = M.negToZero(100 < t.series[g] ? 100 : t.series[g]) / 100,
                            m = Math.round(this.totalAngle * b) + this.startAngle,
                            v = void 0;
                        e.globals.dataChanged && (x = this.startAngle, v = Math.round(this.totalAngle * M.negToZero(e.globals.previousPaths[g]) / 100) + x), 360 <= Math.abs(m) + Math.abs(f) && (m -= .01), 360 <= Math.abs(v) + Math.abs(x) && (v -= .01);
                        var y = m - f,
        ...
        Ft = (o(Rt, [{
            ...
            value: function(t) {
                ...
                if ("area" === e)
                    for (var d = n.fillPath({
                            seriesNumber: i
                        }), g = 0; g < s.areaPaths.length; g++) {
                        var u = r.renderPaths(T(T({}, c), {}, {
            ...
            value: function(t) {
                for (var e, i = t.series, a = t.realIndex, s = t.i, o = t.x, r = (t.y, t.pX), n = t.pY, l = t.pathsFrom, h = t.linePaths, c = t.areaPaths, d = t.seriesIndex, g = t.lineYPosition, u = t.xArrj, p = t.yArrj, f = this.w, x = new I(this.ctx), b = this.yRatio, m = l.prevY, v = l.linePath, y = l.areaPath, w = l.pathFromLine, k = l.pathFromArea, A = M.isNumber(f.globals.minYArr[a]) ? f.globals.minYArr[a] : f.globals.minY, S = 1 < f.globals.dataPoints ? f.globals.dataPoints - 1 : f.globals.dataPoints, C = 0; C < S; C++) {
    ...
    function Wt(t, e) {
        s(this, Wt), this.ctx = t, this.w = t.w, this.xRatio = e.xRatio, this.yRatio = e.yRatio, this.dynamicAnim = this.w.config.chart.animations.dynamicAnimation, this.helpers = new Tt(t), this.rectRadius = this.w.config.plotOptions.heatmap.radius, this.strokeWidth = this.w.config.stroke.show ? this.w.config.stroke.width : 0
    }
    ...
    function ce(t) {
        s(this, ce), this.ctx = t, this.w = t.w, this.documentEvent = M.bind(this.documentEvent, this)
    }
    ...
    var Oe, We, Be, Ve, Ge, _e, je = (o(Ke, [{
            ...
            value: function(p) {
                ...
                return p.forEach(function(t) {
                    ...
                    var u = b.group({
                        ...
                        seriesName: M.escapeString(x.globals.seriesNames[g]),
                        rel: g + 1,
                        "data:realIndex": g
                    });
                    ...
                    t.forEach(function(t, e) {
                        ...
                        r.node.classList.add("apexcharts-treemap-rect"), r.attr({
                            fill: h
        ...
        Ue = (o(Qe, [{
            ...
            value: function(t) {
                var e = t.firstVal,
                    ...
                    c = "month",
                    d = 0;
                1 < e.minDate ? (l = (h.determineDaysOfMonths(a + 1, e.minYear) - i + 1) * o, n = M.monthMod(a + 1), t = s + d, e = M.monthMod(n), 0 === (i = n) && (c = "year", i = t, t += d += e = 1), this.timeScaleArray.push({
                    position: l,
                    value: i,
                    unit: c,
                    year: t,
                ...
                for (var g = n + 1, u = l, p = 0; p < r; p++, 0) {
                    0 === (g = M.monthMod(g)) ? (c = "year", d += 1) : c = "month";
            ...
            value: function(t) {
                ...
                var i = t.firstVal,
                    ...
                    d = h,
                    g = e(c, a, s);
                0 === i.minHour && 1 === i.minDate ? (t = 0, d = M.monthMod(i.minMonth), l = "month", c = i.minDate, r++) : 1 !== i.minDate && 0 === i.minHour && 0 === i.minMinute && (t = 0, h = i.minDate, g = e(c = d = h, a, s)), this.timeScaleArray.push({
                    position: t,
                    value: d,
                    unit: l,
        ...
        qe = (o(Je, [{
            ...
            value: function(a, t) {
                ...
                if (r.comboCharts) 0 < l.series.length && m.push(e.draw(l.series, "area", l.i)), 0 < d.series.length && (s.config.chart.stacked ? (f = new Lt(this.ctx, t), m.push(f.draw(d.series, d.i))) : (this.ctx.bar = new B(this.ctx, t), m.push(this.ctx.bar.draw(d.series, d.i)))), 0 < n.series.length && m.push(e.draw(n.series, "line", n.i)), 0 < g.series.length && m.push(i.draw(g.series, g.i)), 0 < u.series.length && m.push(i.draw(u.series, u.i)), 0 < h.series.length && (x = new Ft(this.ctx, t, !0), m.push(x.draw(h.series, "scatter", h.i))), 0 < c.series.length && (x = new Ft(this.ctx, t, !0), m.push(x.draw(c.series, "bubble", c.i)));
                    ...
                    case "rangeBar":
                        ...
                        break;
                    case "heatmap":
                        m = new Mt(this.ctx, t).draw(r.series);
                        break;
                    case "treemap":
            ...
            value: function() {
                ...
                s && !t.config.chart.sparkline.enabled && (o = (s = M.getBoundingClientRect(s)).bottom, s = s.bottom - s.top, o = Math.max(2.05 * t.globals.radialSize, s));
                a = o + e.translateY + i + a;
                e.dom.elLegendForeign && e.dom.elLegendForeign.setAttribute("height", a), e.dom.elWrap.style.height = a + "px", I.setAttrs(e.dom.Paper.node, {
                    height: a
                ...
                o.config.chart.brush.enabled && "function" != typeof o.config.chart.events.selection && ((i = o.config.chart.brush.targets || [o.config.chart.brush.target]).forEach(function(t) {
                    ...
                    i.forEach(function(t) {
                        ...
                        t = a.w.config.yaxis.reduce(function(t, e, i) {
                            return [].concat(g(t), [T(T({}, a.w.config.yaxis[i]), {}, {
                                min: s[0].min,
                                max: s[0].max
                            })])
                        }, []);
        ...
        Ze = (o($e, [{
            ...
            value: function(t, e) {
                var i = this,
                    ...
                    s = this.w;
                return s.globals.shouldAnimate = e, s.globals.dataChanged = !0, e && this.ctx.series.getPreviousPaths(), s.globals.axisCharts ? (0 === (e = t.map(function(t, e) {
                    return i._extendSeries(t, e)
                })).length && (e = [{
                    data: []
                }]), s.config.series = e) : s.config.series = t.slice(), a && (s.globals.initialSeries = M.clone(s.config.series)), this.ctx.update()
            }
        }, {
            key: "_extendSeries",
            value: function(t, e) {
    ...
    function Ke(t, e) {
        s(this, Ke), this.ctx = t, this.w = t.w, this.strokeWidth = this.w.config.stroke.width, this.helpers = new Tt(t), this.dynamicAnim = this.w.config.chart.animations.dynamicAnimation, this.labels = []
    }
    ...
    Oe = "undefined" != typeof window ? window : void 0, We = function(s, o) {
            ...
            h.PathArray = function(t, e) {
                ...
                create: function(e) {
                    if (h.Box.apply(this, [].slice.call(arguments)), e instanceof h.Element) {
                        ...
                        try {
                            ...
                            e instanceof h.Shape ? (h.parser.draw || h.prepare(), a = (i = e.clone(h.parser.draw.instance).show()).node.getBBox(), i.remove()) : a = {
                                x: e.node.clientLeft,
                                y: e.node.clientTop,
                ...
                var o = i.bind(a || t.instance || t),
                    ...
                    a = e.split(".")[0],
                    e = e.split(".")[1] || "*";
                h.listeners[r] = h.listeners[r] || {}, h.listeners[r][a] = h.listeners[r][a] || {}, h.listeners[r][a][e] = h.listeners[r][a][e] || {}, i._svgjsListenerId || (i._svgjsListenerId = ++h.listenerId), h.listeners[r][a][e][i._svgjsListenerId] = o, t.addEventListener(a, o, s || {
                    passive: !0
                })
                ...
                for (var e = this.value, i = this.parse(t), a = 0, s = 0; !1 !== a || !1 !== s;) {
                    ...
                    var l = function(t, e, i, a, s, o, r) {
                            for (var n = t.slice(e, i || r), l = a.slice(s, o || r), h = 0, c = {
                                    ...
                                    pos: [0, 0],
                                    start: [0, 0]
                                }; n[h] = ei.call(c, n[h]), l[h] = ei.call(d, l[h]), n[h][0] != l[h][0] || "M" == n[h][0] || "A" == n[h][0] && (n[h][4] != l[h][4] || n[h][5] != l[h][5]) ? (Array.prototype.splice.apply(n, [h, 1].concat(ai.call(c, n[h]))), Array.prototype.splice.apply(l, [h, 1].concat(ai.call(d, l[h])))) : (n[h] = ii.call(c, n[h]), l[h] = ii.call(d, l[h])), ++h != n.length || h != l.length;) h == n.length && n.push(["C", c.pos[0], c.pos[1], c.pos[0], c.pos[1], c.pos[0], c.pos[1]]), h == l.length && l.push(["C", d.pos[0], d.pos[1], d.pos[0], d.pos[1], d.pos[0], d.pos[1]]);
                            return {
                                start: n,
                                dest: l
                            }
        ...
        function() {
            ...
            selectize: function(t, e) {
                return "object" == typeof t && (e = t, t = !0), (this.remember("_selectHandler") || new ti(this)).init(void 0 === t || t, e || {}), this
            }
        ...
        function() {
            ...
            function a(e) {
                var t = this;
                i(this), this.__resizeRAF__ && r(this.__resizeRAF__), this.__resizeRAF__ = o(function() {
            ...
            var e, s, o = (e = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || function(t) {
    ...
    var oi = (o(li, [{
            key: "initModules",
            value: function() {
                this.ctx.publicMethods = ["updateOptions", "updateSeries", "appendData", "appendSeries", "toggleSeries", "showSeries", "hideSeries", "setLocale", "resetSeries", "zoomX", "toggleDataPointSelection", "dataURI", "addXaxisAnnotation", "addYaxisAnnotation", "addPointAnnotation", "clearAnnotations", "removeAnnotation", "paper", "destroy"], this.ctx.eventList = ["click", "mousedown", "mousemove", "mouseleave", "touchstart", "touchmove", "touchleave", "mouseup", "touchend"], this.ctx.animations = new S(this.ctx), this.ctx.axes = new ot(this.ctx), this.ctx.core = new qe(this.ctx.el, this.ctx), this.ctx.config = new j({}), this.ctx.data = new Z(this.ctx), this.ctx.grid = new tt(this.ctx), this.ctx.graphics = new I(this.ctx), this.ctx.coreUtils = new P(this.ctx), this.ctx.crosshairs = new rt(this.ctx), this.ctx.events = new t(this.ctx), this.ctx.exports = new Q(this.ctx), this.ctx.localization = new st(this.ctx), this.ctx.options = new E, this.ctx.responsive = new nt(this.ctx), this.ctx.series = new O(this.ctx), this.ctx.theme = new lt(this.ctx), this.ctx.formatters = new $(this.ctx), this.ctx.titleSubtitle = new ht(this.ctx), this.ctx.legend = new xt(this.ctx), this.ctx.toolbar = new bt(this.ctx), this.ctx.dimensions = new pt(this.ctx), this.ctx.updateHelpers = new Ze(this.ctx), this.ctx.zoomPanSelection = new mt(this.ctx), this.ctx.w.globals.tooltip = new Ct(this.ctx)
            }
        }]), li),
        ri = (o(ni, [{
            key: "clear",
    ...
    return o(hi, [{
        ...
        value: function() {
            ...
            return new Promise(function(t, e) {
                ...
                "front" === h.config.grid.position && i && h.globals.dom.elGraphical.add(i.el), "front" === h.config.xaxis.crosshairs.position && l.crosshairs.drawXCrosshairs(), "front" === h.config.yaxis[0].crosshairs.position && l.crosshairs.drawYCrosshairs(), "front" === h.config.annotations.position && (h.globals.dom.Paper.add(h.globals.dom.elAnnotations), l.annotations.drawAxesAnnotations()), h.globals.noData || (h.config.tooltip.enabled && !h.globals.noData && l.w.globals.tooltip.drawTooltip(n.xyRatios), h.globals.axisCharts && (h.globals.isXNumeric || h.config.xaxis.convertedCatToNumeric || h.globals.isTimelineBar) ? (h.config.chart.zoom.enabled || h.config.chart.selection && h.config.chart.selection.enabled || h.config.chart.pan && h.config.chart.pan.enabled) && l.zoomPanSelection.init({
                    xyRatios: n.xyRatios
        ...
        value: function(t) {
            ...
            return this.w.config.series = i, e && (this.w.globals.initialSeries = M.clone(this.w.config.series)), this.update()
        }
    }, {
        key: "update",
        value: function(a) {
        ...
        key: "initOnLoad",
        value: function() {
            for (var t = document.querySelectorAll("[data-apexcharts]"), e = 0; e < t.length; e++) new hi(t[e], JSON.parse(t[e].getAttribute("data-options"))).render()
        }
    }, {
        key: "exec",
        value: function(t, e) {
