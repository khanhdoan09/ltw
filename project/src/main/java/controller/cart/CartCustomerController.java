...
@WebServlet(name = "CartCustomerController", value = "/cartCustomer")
public class CartCustomerController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<ProductInCart> listProductInCart = DaoCart.getInstance().getListProductInCart("123", productName, productBrand, productPrice);
