...
public class ListImg extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<String> listImg= DaoProduct.getInstance().getListImg(id, color);
        ...
        response.getWriter().write(toJson(listImg,  listColor));
    }

    public String toJson(List<String> listImg, List<Integer> listSize) {
        String re="{";
        re+="\"listImg\":[";
        for (String str : listImg) {
            re+="\""+str+"\",";
